...
public class CopierActionMenu extends ItemCombinerMenu {
    public CopierActionMenu(MenuType type, int a, Inventory inventory) {
        this(type, a, inventory, ContainerLevelAccess.NULL);
    }

    public CopierActionMenu(MenuType type, int a, Inventory inventory, ContainerLevelAccess access) {
